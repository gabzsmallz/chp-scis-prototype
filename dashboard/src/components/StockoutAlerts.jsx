    ...
    if (!alerts || alerts.length === 0) {
          return (
                  <Paper sx={{ p: 4, textAlign: 'center', bgcolor: '#f0faf4' }}>
                            <Typography variant="h6" color="success.main">No active stockout alerts</Typography>Typography>
    ...
    return (
          <Paper elevation={2} sx={{ p: 2 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
                        ...
                        <Typography variant="h6" fontWeight="bold">Active Stockout Alerts</Typography>Typography>
                  ...
                  {alerts.map((alert, i) => {
                      ...
                      return (
                                    <ListItem key={i} alignItems="flex-start" sx={{
                                                  ...
                                                  <ListItemIcon><PersonIcon color="warning" /></ListItemIcon>ListItemIcon>
                                                  <ListItemText
                                                                    primary={
                                                                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
                                                                                                            <Typography fontWeight="bold">{alert.chp_name || alert.chp_id}</Typography>Typography>
